...
app.config[
    'SQLALCHEMY_DATABASE_URI'] = 'postgresql://postgres:postgres@postgres:5432/Cloud'  # 'postgresql://usuario:contraseña@localhost:5432/Cloud' Cambiar esta linea si no se usa docker
